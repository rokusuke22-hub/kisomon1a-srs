...
var SPREADSHEET_ID = "★ここに新規作成したスプレッドシートのIDを貼り付け★";

// シート名（★基礎問題精講I・A用。他教材と重複不可）
var SHEET_NAME_DATA = "K1_SRS_Data";    // ネクステ: NS_SRS_Data, シス単: SRS_Data_v5
var SHEET_NAME_META = "K1_SRS_Meta";    // ネクステ: NS_SRS_Meta, シス単: SRS_Meta
...
function runAllTests() {
  Logger.log("========================================");
  Logger.log("基礎問題精講I・A SRS GAS テスト実行 - " + new Date().toISOString());
  Logger.log("========================================");
...
function checkDataStatus() {
  ...
  if (sheet) {
    var lastRow = sheet.getLastRow();
    Logger.log("========================================");
    Logger.log("基礎問題精講I・A SRS データ状態チェック");
    Logger.log("========================================");
